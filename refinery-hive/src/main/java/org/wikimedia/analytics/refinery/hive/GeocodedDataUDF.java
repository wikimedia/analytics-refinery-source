...
public class GeocodedDataUDF extends GenericUDF {

    Map<String, String> result;
    private ObjectInspector argumentOI;
    private Geocode geocode;

    static final Logger LOG = Logger.getLogger(GeocodedDataUDF.class.getName());
    ...
    public ObjectInspector initialize(ObjectInspector[] arguments)
        ...
        if (arguments.length != 1) {
            throw new UDFArgumentLengthException("The GeocodedDataUDF takes an array with only 1 element as argument");
        }
    ...
    public String getDisplayString(String[] arguments) {
        ...
        return "geocoded_data(" + arguments[0] + ")";
    }
}
