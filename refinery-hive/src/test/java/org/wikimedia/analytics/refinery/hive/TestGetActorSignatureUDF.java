...
public class TestGetActorSignatureUDF extends TestCase {

    GetActorSignatureUDF getActorSignatureUDF = new GetActorSignatureUDF();

    public void testEvaluateNullIP() {
        String actorSignature = getActorSignatureUDF.evaluate(
                null,
    ...
    public void testEvaluateNullUserAgent() {
        String actorSignature = getActorSignatureUDF.evaluate(
                "192.168.12.2",
                null,
                "pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7",
    ...
    public void testEvaluateNullAcceptLanguage() {
        String actorSignature = getActorSignatureUDF.evaluate(
                "192.168.12.2",
                "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML like Gecko) Chrome/37.0.2062.120 Safari/537.36",
                null,
    ...
    public void testEvaluateNullUriHost() {
        String actorSignature = getActorSignatureUDF.evaluate(
                "192.168.12.2",
                "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML like Gecko) Chrome/37.0.2062.120 Safari/537.36",
                "pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7",
    ...
    public void testEvaluateNullUriQuery() {
        String actorSignature = getActorSignatureUDF.evaluate(
                "192.168.12.2",
                "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML like Gecko) Chrome/37.0.2062.120 Safari/537.36",
                "pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7",
    ...
    public void testEvaluateNullXAnalyticsMap() {
        String actorSignature = getActorSignatureUDF.evaluate(
                "192.168.12.2",
                "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML like Gecko) Chrome/37.0.2062.120 Safari/537.36",
                "pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7",
