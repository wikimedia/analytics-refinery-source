    ...
    mwEventLines.map { line =>
      ...
      new MediawikiEvent(
        ...
        revisionDetails = new MediawikiEventRevisionDetails(
          ...
          revIsDeletedByPageDeletion = valueMap.getOrElse("revIsDeleted", revIsDeleted).asInstanceOf[Option[Boolean]],
          revDeletedByPageDeletionTimestamp = valueMap.getOrElse("revDeletedTimestamp", revDeletedTimestamp).asInstanceOf[Option[Timestamp]],
