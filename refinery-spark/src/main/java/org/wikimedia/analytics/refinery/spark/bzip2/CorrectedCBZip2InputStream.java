...
/**
 * This code is shamelessly copied and slightly modified from
 * hadoop-common trunk/release-2.6.0.
 * Modifications are at lines 730 to 750, fixing the algorithm
 * as in https://github.com/apache/commons-compress/pull/91/
 */
 ...
 * {@link org.apache.hadoop.io.compress.bzip2.CBZip2OutputStream CBZip2OutputStream}
 ...
 * </p>
 */
public class CorrectedCBZip2InputStream extends InputStream implements BZip2Constants {
  ...
  */
  private CorrectedCBZip2InputStream.Data data;
  ...
  *             if <tt>in == null</tt>
  */
  public CorrectedCBZip2InputStream(final InputStream in, READ_MODE readMode)
      throws IOException {
    this(in, readMode, false);
  }

  private CorrectedCBZip2InputStream(final InputStream in, READ_MODE readMode, boolean skipDecompression)
      throws IOException {
    ...
    init();
      ...
      skipResult = this.skipToNextMarker(CorrectedCBZip2InputStream.BLOCK_DELIMITER,DELIMITER_BIT_LENGTH);
 ...
 * @throws IOException
  ...
  public static long numberOfBytesTillNextMarker(final InputStream in) throws IOException{
    CorrectedCBZip2InputStream anObject = new CorrectedCBZip2InputStream(in, READ_MODE.BYBLOCK, true);
    return anObject.getProcessedByteCount();
  }

  public CorrectedCBZip2InputStream(final InputStream in) throws IOException {
  ...
  */
  ...
  private void recvDecodingTables() throws IOException {
    ...
    /* Now the selectors */
    /******************************************************
     * This portion of code is updated to match
     * https://github.com/apache/commons-compress/pull/91/
     */
